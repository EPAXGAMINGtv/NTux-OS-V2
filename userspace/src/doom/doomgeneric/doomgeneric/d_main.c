...
void D_DoomLoop (void)
{
    ...
    DEH_printf("D_DoomLoop: TryRunTics begin\n");
    TryRunTics();
    DEH_printf("D_DoomLoop: TryRunTics done\n");

    I_SetWindowTitle(gamedescription);
    I_GraphicsCheckCommandLine();
    I_SetGrabMouseCallback(D_GrabMouseCallback);
    DEH_printf("D_DoomLoop: I_InitGraphics begin\n");
    I_InitGraphics();
    DEH_printf("D_DoomLoop: I_InitGraphics done\n");
    I_EnableLoadingDisk();

    DEH_printf("D_DoomLoop: V_RestoreBuffer begin\n");
    V_RestoreBuffer();
    DEH_printf("D_DoomLoop: V_RestoreBuffer done\n");
    DEH_printf("D_DoomLoop: R_ExecuteSetViewSize begin\n");
    R_ExecuteSetViewSize();
    DEH_printf("D_DoomLoop: R_ExecuteSetViewSize done\n");

    DEH_printf("D_DoomLoop: D_StartGameLoop begin\n");
    D_StartGameLoop();
    DEH_printf("D_DoomLoop: D_StartGameLoop done\n");
...
//    W_PrintDirectory();
    ...
    ST_Init ();
    DEH_printf("ST_Init: done (D_DoomMain)\n");
    ...
    if (gameaction != ga_loadgame )
    {
        ...
        {
            DEH_printf("G_InitNew: begin\n");
			G_InitNew (startskill, startepisode, startmap);
            DEH_printf("G_InitNew: done\n");
        }
		else
        {
            DEH_printf("D_StartTitle: begin\n");
			D_StartTitle ();                // start up intro loop
            DEH_printf("D_StartTitle: done\n");
        }
    }

    DEH_printf("D_DoomLoop: enter\n");
    D_DoomLoop ();
}
